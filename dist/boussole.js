...
/***/ "./src/vue/VueSpatialNavigation.ts":
/*!*****************************************!*\
  !*** ./src/vue/VueSpatialNavigation.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../SpatialNavigation */ "./src/SpatialNavigation.ts");
...
const vueSpatialNavigation = {
    disable() {
        _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.pause();
    },
    enable() {
        _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.resume();
    },
    install(app, config) {
        const globalConfig = _types_Configuration__WEBPACK_IMPORTED_MODULE_3__.defaultConfiguration;
        Object.assign(globalConfig, config);
        _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.init();
        _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.set(undefined, globalConfig);
        app.provide('$SpatialNavigation', _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn);
        ...
        const focusSectionDirective = {
            beforeMount(element, binding) {
                ...
                if (binding.value && binding.value.id && binding.value.conf) {
                    ...
                    try {
                        _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.add(sectionId, config);
                    }
                    catch (error) { }
                }
                else {
                    sectionId = _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.add(undefined, _types_Configuration__WEBPACK_IMPORTED_MODULE_3__.defaultConfiguration);
                }
                // set sectionid to data set for removing when unbinding
                // set sectionid to data set for removing when unbinding
                element.dataset['sectionId'] = sectionId;
                _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.set(sectionId, assignConfig(sectionId, binding.value.conf));
                // set default section
                if (binding.modifiers['default']) {
                    _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.setDefaultSection(sectionId);
                }
            },
            mounted(element, binding) {
                ...
                if (sectionId) {
                    _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.hasBeenWaitingForMounted(sectionId);
                }
            },
            unmounted(element) {
                if (element.dataset['sectionId']) {
                    _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.remove(element.dataset['sectionId']);
                }
            }
        };
        ...
        const disableSection = (sectionId, disable) => {
            if (disable === false) {
                _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.enable(sectionId);
            }
            else {
                _SpatialNavigation__WEBPACK_IMPORTED_MODULE_0__.sn.disable(sectionId);
            }
        };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vueSpatialNavigation);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SpatialNavigation": () => (/* reexport safe */ _SpatialNavigation__WEBPACK_IMPORTED_MODULE_1__.SpatialNavigation),
/* harmony export */   "defaultConfiguration": () => (/* reexport safe */ _types_Configuration__WEBPACK_IMPORTED_MODULE_2__.defaultConfiguration),
/* harmony export */   "vjsn": () => (/* reexport safe */ _vue_VueSpatialNavigation__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _vue_VueSpatialNavigation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vue/VueSpatialNavigation */ "./src/vue/VueSpatialNavigation.ts");
...
//# sourceMappingURL=boussole.js.map