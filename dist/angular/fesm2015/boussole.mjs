...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BoussoleService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
BoussoleComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: BoussoleComponent, selectors: [["lib-boussole"]], decls: 2, vars: 0, template: function BoussoleComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BoussoleComponent, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FocusSectionDirective, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BoussoleModule, [{
            type: NgModule,
            args: [{
                    declarations: [
                        BoussoleComponent,
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(BoussoleModule, { declarations: [BoussoleComponent,
            FocusDirective,
