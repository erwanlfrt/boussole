...
CompassService.ɵfac = function CompassService_Factory(t) { return new (t || CompassService)(); };
CompassService.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: CompassService, factory: CompassService.ɵfac, providedIn: 'root' });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CompassService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CompassModule, [{
            type: NgModule,
            args: [{
                    declarations: [
                        FocusDirective,
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(CompassModule, { declarations: [FocusDirective,
